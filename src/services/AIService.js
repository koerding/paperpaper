...
3.  Document Assessment: Evaluate the OVERALL paper against the DOCUMENT RULES below. Provide scores, assessments, recommendations for each of the criteria given. Prepend "assessment" and "recommendation" with "MnK{originalRuleNumber}: " IF the feedback directly relates to a rule.
