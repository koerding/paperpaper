...
// Clean version - ensures no extra JSX is included.
'use client'
...
export default function ResultsPage() {
  ...
  // *** THIS IS THE CORRECT JSX STRUCTURE - NO MnK Summary HERE ***
  return (
    <div className="space-y-8">
      ...
      {submission.status === 'completed' && submission.results && (
         // *** THIS is where the results should render ***
         <ResultsDisplay results={submission.results} />
         // *** Make sure NO OTHER major component JSX is below here ***
      )}
